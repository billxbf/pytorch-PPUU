...
opt.mfile = f'model=fwd-cnn-vae-fp-layers=3-bsize=64-ncond=20-npred=20-lrt=0.0001-nfeature=256-dropout=0.1-nz=32-beta=1e-06' \
            f'-zdropout=0.5-gclip=5.0-warmstart=0-seed=1-reg=0.0-concat=0-ksize={opt.ksize}-pt={opt.position_threshold}.model'
...
scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=75_000/opt.epoch_size, gamma=0.1)
